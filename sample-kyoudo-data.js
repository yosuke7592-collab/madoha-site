globalThis.MADOHA_KYOUDO_SAMPLE = {
  ...
  "measurement": {
    ...
    "mode": "保存資料・公開検索結果をもとにした商品確認用の仮データ",
    "models": [
  ...
  "executiveSummary": {
    "overallRating": "要改善",
    "improvementPotential": "大",
    "headline": "会社の特徴は伝わります。しかし、選ばれる理由の裏付けが不足しています。",
    "opportunityLoss": "地域密着と、不動産・建築をまとめて相談できる強みが、AIの推薦理由になっていません。",
    "competitorGap": "競合は地域サイトで具体的に紹介されています。協同住宅は、実績や事例の第三者情報で差をつけられています。",
    "keyPoint": "サービスの幅は十分に伝わっています。実績・事例・第三者情報を補えば、会社名を含まない質問でも候補に入りやすくなります。",
    "currentPosition": "公式サイトから、浦安・市川の地域密着企業だと分かります。不動産、建築、資金相談をまとめて扱う点も確認できます。第三者の比較情報では、上位候補として選ぶ根拠がまだ不足しています。",
    "paidValue": "最初に営業年数の表現を確認し、誤情報の原因をなくします。次に、購入とリフォームをまとめて支援した事例を公開します。その後、第三者サイトでも同じ強みが伝わる状態を作ります。"
  },
  "facts": [
    {
  ...
  "perception": {
    ...
    "interpretation": "事業内容は理解しやすい状態です。一方、実績・事例・顧客の声が不足しています。そのため、AIが『選ぶ理由』を説明しにくい可能性があります。"
  },
  "queries": [
    {
      "id": "nb-buy",
  ...
  "issues": [
    {
      ...
      "severity": "high",
      "fact": "第三者情報では、宅建業免許の取得日は1984年6月20日です。ただし、免許取得日は創立日や営業開始日を証明しません。",
      "observed": "公式サイトに『地元浦安で32年』という表現があります。いつを基準にした年数かは明確ではありません。",
      "impact": "基準年が不明です。AIが営業年数について異なる数字を答える恐れがあります。",
      "action": "登記・免許・社内沿革で、創立日と営業開始日を確認します。その後、年数表現を固定年月に統一します。",
      "evidenceUrl": "https://www.kyoudo.jp/",
  ...
  "baseline": {
    ...
    "metrics": [
      ...
      },
      {
        "name": "確認した情報源",
        "value": "5サイト",
        "definition": "本サンプルで根拠を確認したWebサイト数"
      },
      {
        "name": "表現の確認が必要",
        "value": "1件",
